...
namespace ComicBookGallery.Data
{
    public class ComicBookRepository
    {
        ...
        {
            /* Repository is requested from and persist data to a database*/
            new ComicBook()
            {
                Id = 1,
        ...
        public ComicBook GetComicBook(int id)
        {
            ...
            {
                /* Checks the id which is being requested by the user */
                if (comicBook.Id == id)
                {
                    /* And if so return the requested comicBook */
                    comicBookToReturn = comicBook;
                    /* Stops looping when the comicBook is found */
                    break;
                }
            }
